      ...
      <div class="card mb-4">
        ...
        <div class="card-body row">
          ...
          <div class="col-10 offset-1 col-sm-4 offset-sm-4 col-lg-2 offset-lg-5 mb-5">
            <center>
              <img id="preview-foto" class="w-100 cropped-img mt-2 mb-2 rounded-circle" src="{{ Storage::url($configuracion->ruta_almacenamiento.'/img/foto-sede/sede.png') }}" alt="foto perfil">
