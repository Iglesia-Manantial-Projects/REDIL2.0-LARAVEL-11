      ...
      <div class="row p-4 m-0 card">
          ...
          <div class="row d-flex card-body">
                      <div class="rounded-2 text-center mb-3">
                          ...
                          <img class="img-fluid" src="{{ $configuracion->version == 1 ? Storage::url($configuracion->ruta_almacenamiento.'/temas/archivos/'.$tema->portada) : ''}}" alt="tutor image 1" />
                      </div>
                      ...
                      <!-- Nombre Categoria -->
                        ...
                        <div class="col-md-6 mb-2 px-2 ">
                          ...
                          <input id="nombre_tema" name="nombre_del_tema" value="{{$tema->titulo}}" type="text" class="form-control"/>
                      ...
                      <!-- URL ENLACE -->
                       <div class="col-md-6 mb-2 px-2 ">
                            ...
                            <input @if($tema->url_externa =! "") value="{{$tema->url_externa}}" @endif id="url_externo" name="url_externo"  type="text" class="form-control"/>
                            <div class="text-danger form-label"></div>
                       </div>
                      ...
                      <!--  Categoria -->
                        <div class="col-md-6 mb-2 px-2">
                                ...
                                <select id="categorias" name="categorias[]" class="select2BusquedaAvanzada form-select" multiple>
                                  ...
                                  <option @if(in_array($categoria->id,$temas_categoria)) selected @endif value="{{ $categoria->id }}" >{{ $categoria->nombre }}</option>
                                  @endforeach
                                </select>
                        </div>
                      <!-- / Categoria  -->
                         ...
                         <div class="col-md-4 mb-2 px-2">
                          ...
                          <select id="tipoUsuarios" name="tipoUsuarios[]" class="select2BusquedaAvanzada form-select" multiple>
                            ...
                            <option @if(in_array($tipoUsuario->id,$tiposUsuarioTema)) selected @endif value="{{ $tipoUsuario->id }}" >{{ $tipoUsuario->nombre }}</option>
                            @endforeach
                          </select>
                      </div>
                    <!-- / Tipo Usuario  -->
                   ...
                   <!--  Sede -->
                      <div class="col-md-4 mb-2 px-2">
                          ...
                          <select id="sedes" name="sedes[]" class="select2BusquedaAvanzada form-select" multiple>
                            ...
                            <option @if(in_array($sede->id, $sedesTema)) selected @endif value="{{ $sede->id }}" >{{ $sede->nombre }}</option>
                            @endforeach
                          </select>
                      </div>
                  <!-- / Sede  -->
                   ...
                   <div class="col-md-4 mb-2 px-2">
                      ...
                      <select id="tipoGrupo" name="tipoGrupo[]" class="select2BusquedaAvanzada form-select" multiple>
                        ...
                        <option @if( in_array($tipo->id, $tiposGrupoTema)) selected @endif value="{{ $tipo->id }}" >{{ $tipo->nombre }}</option>
                        @endforeach
                      </select>
                   </div>
                  <!-- / Tipo Grupo  -->
                  ...
                  <!-- / Grupo  -->
                        ...
                        <textarea id="myeditorinstance"><?php echo $tema->contenido;?>  </textarea>
