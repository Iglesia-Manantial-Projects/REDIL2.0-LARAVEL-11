...
return new class extends Migration {
  ...
  public function up(): void
  {
    ...
    Schema::create($tableNames['permissions'], function (Blueprint $table) {
      ...
      // Adicionales para Redil
      $table->string('titulo', 100)->nullable();
      $table->text('descripcion')->nullable();
      // Fin adicionales para REDIL
    ...
    Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
      ...
      $table->integer('lista_asistentes_sede_id')->nullable();
      $table->integer('lista_grupos_sede_id')->nullable();
      $table->integer('lista_reportes_grupo_sede_id')->nullable();
      $table->integer('lista_reuniones_sede_id')->nullable();
      $table->integer('lista_sedes_sede_id')->nullable();
      $table->integer('lista_ingresos_sede_id')->nullable();
      $table->integer('lista_peticiones_sede_id')->nullable();
      $table->integer('ver_sumatoria_ingresos_reportes_grupo_id')->nullable();
      $table->boolean('dependiente')->nullable()->default(0);
      // Fin adicionales para REDIL
